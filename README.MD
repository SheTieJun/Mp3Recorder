...
> tip: 背景音乐支持网络链接，但是网络差的时候可能导致ANR,所有请尽量不要使用网络链接作为背景应用
> 最低版本提升到：`21` 如果需要`19`的请使用`1.5.0`以前的版本
...
recorder {
    ...
    libVersion = "1.6.0"// lib版本 :默认1.3.0
}
```
### 缺点
...
#### [demo代码](https://github.com/SheTieJun/Mp3Recorder/tree/master/app)
...
### 1. 录音方式一：[MixRecorder](/recorder-mix/ReadMe.MD)
### 2. 录音方式二： [MP3Recorder](/recorder-sim/README.MD)
